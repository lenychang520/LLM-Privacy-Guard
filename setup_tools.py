...
def _register_auto_start_systemd(port: int, upstream: str) -> bool:
    ...
    unit_content = (
        ...
        "# Uncomment to log every request (original + filtered body) for debugging.\n"
        "# Off by default — would write sensitive data to disk.\n"
        "#Environment=PRIVACY_GUARD_DEBUG_LOG=1\n"
        "\n"
        "[Install]\n"
